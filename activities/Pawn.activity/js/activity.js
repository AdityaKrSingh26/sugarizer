define(["sugar-web/activity/activity"], function (activity) {
	...
	requirejs(['domReady!'], function (doc) {
		...
		// Initialize StickmanAnimator once DOM is ready
		class StickmanAnimator {
			...
			initCanvas() {
				this.canvas = document.getElementById('stickman-canvas'); // Use stickman-canvas ID
				this.ctx = this.canvas.getContext('2d');
				this.resizeCanvas();
			...
			exportAnimation() {
				...
				const stream = recordCanvas.captureStream(15); // Reduced from 30 to 24 FPS
		...
		// Create instance of animator after setup
		let animator = null;
